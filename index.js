    ...
    .prompt([
      {
        ...
        choices: [
          ...
          { name: 'update an employee role', value: 'updateEmployeeRoleId' },
          { name: 'update an employee manager', value: 'updateEmployeeManagerId' },
        ],
      },
    ...
    .then((answers) => {
      switch (answers.choices) {
        ...
        case "addEmployee":
          addEmployee()
          break;
        case "updateEmployeeRoleId":
          updateEmployeeRoleId()
          break;
          case "updateEmployeeManagerId":
...
function updateEmployeeManagerId() {
  inquirer
    .prompt([
      {
        type: 'input',
